...
func (UnimplementedAiChatServer) AsyncToolCall(context.Context, *AsyncToolCallReq) (*AsyncToolCallRes, error) {
	return nil, status.Error(codes.Unimplemented, "method AsyncToolCall not implemented")
}
func (UnimplementedAiChatServer) AsyncToolResult(context.Context, *AsyncToolResultReq) (*AsyncToolResultRes, error) {
	return nil, status.Error(codes.Unimplemented, "method AsyncToolResult not implemented")
}
func (UnimplementedAiChatServer) ListAsyncResults(context.Context, *ListAsyncResultsReq) (*ListAsyncResultsResp, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAsyncResults not implemented")
}
func (UnimplementedAiChatServer) AsyncResultStats(context.Context, *EmptyReq) (*AsyncResultStat, error) {
	return nil, status.Error(codes.Unimplemented, "method AsyncResultStats not implemented")
}
