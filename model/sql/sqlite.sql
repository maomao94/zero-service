...
INSERT INTO device_point_mapping (tag_station, coa, ioa, device_id, device_name, td_table_type, enable_push, enable_raw_insert, ext_1, ext_2, description)
VALUES ('330KV', 1, 1, 'device_1_1', '遥信设备1-1', '遥信', 1, 1, 'normal', 'switch', '示例遥信设备1'),
       ('330KV', 1, 2, 'device_1_2', '遥信设备1-2', '遥信', 1, 1, 'normal', 'switch', '示例遥信设备2'),
       ('330KV', 1, 3, 'device_1_3', '遥信设备1-3', '遥信', 1, 1, 'alarm', 'temp', '示例遥信设备3'),
       ('330KV', 1, 4, 'device_1_4', '遥信设备1-4', '遥信', 1, 1, 'alarm', 'pressure', '示例遥信设备4'),
       ('330KV', 1, 5, 'device_1_5', '遥信设备1-5', '遥信', 1, 1, 'control', 'valve', '示例遥信设备5'),

       ('330KV', 1, 6, 'device_1_1', '遥测设备1-6', '遥信,告警', 1, 1, 'normal', 'voltage', '示例遥测设备6'),
       ('330KV', 1, 7, 'device_1_2', '遥测设备1-7', '遥信', 1, 1, 'normal', 'current', '示例遥测设备7'),
       ('330KV', 1, 8, 'device_1_3', '遥测设备1-8', '遥信', 1, 1, 'alarm', 'frequency', '示例遥测设备8'),
       ('330KV', 1, 9, 'device_1_4', '遥测设备1-9', '遥信', 1, 1, 'control', 'pump', '示例遥测设备9'),
       ('330KV', 1, 10, 'device_1_5', '遥测设备1-10', '遥信', 1, 1, 'normal', 'power', '示例遥测设备10');
