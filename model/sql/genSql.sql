CREATE TABLE IF NOT EXISTS `device_point_mapping` (
    ...
    `dept_code` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '机构code',
...
CREATE TABLE IF NOT EXISTS `plan_exec_item` (
    ...
    `item_type` VARCHAR(64) NOT NULL DEFAULT '' COMMENT '执行项类型',
    ...
    `last_message` varchar(1024) DEFAULT '' COMMENT '上次结果描述',
...
CREATE TABLE IF NOT EXISTS `plan_exec_log` (
    ...
    `message` varchar(1024) DEFAULT '' COMMENT '结果描述',
