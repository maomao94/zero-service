...
var file_extproto_proto_extTypes = []protoimpl.ExtensionInfo{
	...
	},
	{
		...
		Field:         5002,
		Name:          "extproto.http_code",
		Tag:           "varint,5002,opt,name=http_code",
		Filename:      "extproto.proto",
	},
}
...
const file_extproto_proto_rawDesc = "" +
	...
	"\thttp_code\x12!.google.protobuf.EnumValueOptions\x18\x8a' \x01(\x05R\bhttpCodeBM\n" +
...
var file_extproto_proto_depIdxs = []int32{
	...
	4, // 3: extproto.http_code:extendee -> google.protobuf.EnumValueOptions
