...
require (
	...
	github.com/volcengine/volcengine-go-sdk v1.2.31 // indirect
...
replace github.com/doquangtan/socketio/v4 => github.com/maomao94/socket.io-golang/v4 v4.0.0-20260527120802-cca61ee929af
