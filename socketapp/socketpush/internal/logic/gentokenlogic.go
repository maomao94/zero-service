...
func (l *GenTokenLogic) GenToken(in *socketpush.GenTokenReq) (*socketpush.GenTokenRes, error) {
	...
	accessToken, err := l.getJwtToken(l.svcCtx.Config.JwtAuth.AccessSecret, now, accessExpire, in.Uid)
	if err != nil {
		return nil, err
	}
...
func (l *GenTokenLogic) getJwtToken(secretKey string, iat, seconds int64, uid string) (string, error) {
