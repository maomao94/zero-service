...
const file_socketgtw_proto_rawDesc = "" +
	...
	"\x06req_id\x18\x01 \x01(\tR\x05reqId\"\x9d\x01\n" +
	"\x15SendToMetaSessionsReq\x12\x15\n" +
	"\x06req_id\x18\x01 \x01(\tR\x05reqId\x12=\n" +
	"\rmeta_sessions\x18\x02 \x03(\v2\x18.socketgtw.PbMetaSessionR\fmetaSessions\x12\x14\n" +
	"\x05event\x18\x03 \x01(\tR\x05event\x12\x18\n" +
	"\apayload\x18\x04 \x01(\tR\apayload\".\n" +
...
var file_socketgtw_proto_depIdxs = []int32{
	0,  // 0: socketgtw.SendToMetaSessionsReq.meta_sessions:type_name -> socketgtw.PbMetaSession
