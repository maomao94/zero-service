...
const (
	...
	PodEngine_ListImages_FullMethodName  = "/podengine.PodEngine/ListImages"
)
...
func (c *podEngineClient) ListImages(ctx context.Context, in *ListImagesReq, opts ...grpc.CallOption) (*ListImagesRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListImagesRes)
	err := c.cc.Invoke(ctx, PodEngine_ListImages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPodEngineServer) StartPod(context.Context, *StartPodReq) (*StartPodRes, error) {
	return nil, status.Error(codes.Unimplemented, "method StartPod not implemented")
}
func (UnimplementedPodEngineServer) StopPod(context.Context, *StopPodReq) (*StopPodRes, error) {
	return nil, status.Error(codes.Unimplemented, "method StopPod not implemented")
}
func (UnimplementedPodEngineServer) RestartPod(context.Context, *RestartPodReq) (*RestartPodRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RestartPod not implemented")
}
...
func (UnimplementedPodEngineServer) GetPodStats(context.Context, *GetPodStatsReq) (*GetPodStatsRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPodStats not implemented")
}
func (UnimplementedPodEngineServer) ListImages(context.Context, *ListImagesReq) (*ListImagesRes, error) {
...
func RegisterPodEngineServer(s grpc.ServiceRegistrar, srv PodEngineServer) {
	// If the following call panics, it indicates UnimplementedPodEngineServer was
...
func _PodEngine_ListImages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListImagesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PodEngineServer).ListImages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PodEngine_ListImages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PodEngineServer).ListImages(ctx, req.(*ListImagesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PodEngine_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PodEngine_ListImages_Handler,
		},
	},
