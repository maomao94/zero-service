...
type ContainerStatePb struct {
	...
	StartedTime   string                 `protobuf:"bytes,6,opt,name=started_time,json=startedTime,proto3" json:"started_time,omitempty"`    // 启动时间
	FinishedTime  string                 `protobuf:"bytes,7,opt,name=finished_time,json=finishedTime,proto3" json:"finished_time,omitempty"` // 结束时间
	ExitCode      string                 `protobuf:"bytes,8,opt,name=exit_code,json=exitCode,proto3" json:"exit_code,omitempty"`             // 退出码
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ContainerPb struct {
	...
	// 卷挂载信息
	VolumeMounts  []string `protobuf:"bytes,8,rep,name=volume_mounts,json=volumeMounts,proto3" json:"volume_mounts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ContainerSpecPb struct {
	...
	// 卷挂载声明（runtime 自行解析）
	VolumeMounts  []string `protobuf:"bytes,7,rep,name=volume_mounts,json=volumeMounts,proto3" json:"volume_mounts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PodSpecPb struct {
	...
	// 优雅终止时间（秒）
	TerminationGracePeriodSeconds int32 `protobuf:"varint,6,opt,name=termination_grace_period_seconds,json=terminationGracePeriodSeconds,proto3" json:"termination_grace_period_seconds,omitempty"`
...
type PodPb struct {
	...
	NetworkMode   string                 `protobuf:"bytes,8,opt,name=network_mode,json=networkMode,proto3" json:"network_mode,omitempty"`    // 网络模式
	CreationTime  string                 `protobuf:"bytes,9,opt,name=creation_time,json=creationTime,proto3" json:"creation_time,omitempty"` // 创建时间
	StartTime     string                 `protobuf:"bytes,10,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`         // 启动时间
	DeletedTime   string                 `protobuf:"bytes,11,opt,name=deleted_time,json=deletedTime,proto3" json:"deleted_time,omitempty"`   // 删除时间
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ContainerStatsPb struct {
	...
	CpuUsagePercentDisplay string  `protobuf:"bytes,4,opt,name=cpu_usage_percent_display,json=cpuUsagePercentDisplay,proto3" json:"cpu_usage_percent_display,omitempty"` // 用于展示
	CpuUsageTotal          int64   `protobuf:"varint,5,opt,name=cpu_usage_total,json=cpuUsageTotal,proto3" json:"cpu_usage_total,omitempty"`
	CpuUsageTotalDisplay   string  `protobuf:"bytes,6,opt,name=cpu_usage_total_display,json=cpuUsageTotalDisplay,proto3" json:"cpu_usage_total_display,omitempty"` // 用于展示
	// 内存统计信息
	MemoryUsage               int64   `protobuf:"varint,7,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`
	MemoryUsageDisplay        string  `protobuf:"bytes,8,opt,name=memory_usage_display,json=memoryUsageDisplay,proto3" json:"memory_usage_display,omitempty"` // 用于展示
	MemoryLimit               int64   `protobuf:"varint,9,opt,name=memory_limit,json=memoryLimit,proto3" json:"memory_limit,omitempty"`
	MemoryLimitDisplay        string  `protobuf:"bytes,10,opt,name=memory_limit_display,json=memoryLimitDisplay,proto3" json:"memory_limit_display,omitempty"` // 用于展示
	MemoryUsagePercent        float64 `protobuf:"fixed64,11,opt,name=memory_usage_percent,json=memoryUsagePercent,proto3" json:"memory_usage_percent,omitempty"`
	MemoryUsagePercentDisplay string  `protobuf:"bytes,12,opt,name=memory_usage_percent_display,json=memoryUsagePercentDisplay,proto3" json:"memory_usage_percent_display,omitempty"` // 用于展示
	// 网络统计信息
	NetworkRxBytes        int64  `protobuf:"varint,13,opt,name=network_rx_bytes,json=networkRxBytes,proto3" json:"network_rx_bytes,omitempty"`
	NetworkRxBytesDisplay string `protobuf:"bytes,14,opt,name=network_rx_bytes_display,json=networkRxBytesDisplay,proto3" json:"network_rx_bytes_display,omitempty"` // 用于展示
	...
	NetworkTxBytesDisplay string `protobuf:"bytes,16,opt,name=network_tx_bytes_display,json=networkTxBytesDisplay,proto3" json:"network_tx_bytes_display,omitempty"` // 用于展示
	// 存储统计信息
	...
	StorageReadBytesDisplay  string `protobuf:"bytes,18,opt,name=storage_read_bytes_display,json=storageReadBytesDisplay,proto3" json:"storage_read_bytes_display,omitempty"` // 用于展示
	StorageWriteBytes        int64  `protobuf:"varint,19,opt,name=storage_write_bytes,json=storageWriteBytes,proto3" json:"storage_write_bytes,omitempty"`
	StorageWriteBytesDisplay string `protobuf:"bytes,20,opt,name=storage_write_bytes_display,json=storageWriteBytesDisplay,proto3" json:"storage_write_bytes_display,omitempty"` // 用于展示
	// 统计时间
...
type ListImagesReq struct {
	...
	IncludeDigests bool                   `protobuf:"varint,4,opt,name=include_digests,json=includeDigests,proto3" json:"include_digests,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ImagePb struct {
	...
	SizeDisplay   string                 `protobuf:"bytes,5,opt,name=size_display,json=sizeDisplay,proto3" json:"size_display,omitempty"`                                              // 用于展示的大小
...
const file_podengine_proto_rawDesc = "" +
	"\n" +
	"\x0fpodengine.proto\x12\tpodengine\x1a\x17validate/validate.proto\"\xbf\x01\n" +
	...
	"\x14last_transition_time\x18\x05 \x01(\tR\x12lastTransitionTime\"\xfd\x01\n" +
	...
	"\fstarted_time\x18\x06 \x01(\tR\vstartedTime\x12#\n" +
	"\rfinished_time\x18\a \x01(\tR\ffinishedTime\x12\x1b\n" +
	"\texit_code\x18\b \x01(\tR\bexitCode\"\xa7\x03\n" +
	...
	"\rvolume_mounts\x18\b \x03(\tR\fvolumeMounts\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	...
	"\rvolume_mounts\x18\a \x03(\tR\fvolumeMounts\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a<\n" +
	"\x0eResourcesEntry\x12\x10\n" +
	...
	"\rrestartPolicy\x18\x05 \x01(\tB\x1c\xfaB\x19r\x17R\x02noR\tonFailureR\x06alwaysR\rrestartPolicy\x12G\n" +
	" termination_grace_period_seconds\x18\x06 \x01(\x05R\x1dterminationGracePeriodSeconds\x12;\n" +
	"\vnetworkMode\x18\a \x01(\tB\x19\xfaB\x16r\x14R\x06bridgeR\x04hostR\x04noneR\vnetworkMode\x12!\n" +
	"\fnetwork_name\x18\b \x01(\tR\vnetworkName\x12M\n" +
	...
	"\rcreation_time\x18\t \x01(\tR\fcreationTime\x12\x1d\n" +
	"\n" +
	"start_time\x18\n" +
	" \x01(\tR\tstartTime\x12!\n" +
	"\fdeleted_time\x18\v \x01(\tR\vdeletedTime\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total\"\xff\x03\n" +
	"\rListPodItemPb\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12+\n" +
	"\x05phase\x18\x03 \x01(\x0e2\x15.podengine.PodPhasePbR\x05phase\x12\x1f\n" +
	"\vcreate_time\x18\x04 \x01(\tR\n" +
	"createTime\x12\x14\n" +
	"\x05image\x18\x05 \x01(\tR\x05image\x12\x19\n" +
	"\bimage_id\x18\x06 \x01(\tR\aimageId\x12\x18\n" +
	"\acommand\x18\a \x01(\tR\acommand\x12\x14\n" +
	"\x05ports\x18\b \x03(\tR\x05ports\x12\x17\n" +
	...
	"\fnetwork_mode\x18\x0e \x01(\tR\vnetworkMode\x12\x16\n" +
	...
	"\x0eremove_volumes\x18\x03 \x01(\bR\rremoveVolumes\"\x0e\n" +
	"\fDeletePodRes\"=\n" +
	"\x0eGetPodStatsReq\x12\x12\n" +
	"\x04node\x182 \x01(\tR\x04node\x12\x17\n" +
	"\x02id\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x02id\"C\n" +
	"\x0eGetPodStatsRes\x121\n" +
	"\x05stats\x18\x01 \x03(\v2\x1b.podengine.ContainerStatsPbR\x05stats\"\xfd\a\n" +
	"\x10ContainerStatsPb\x12!\n" +
	"\fcontainer_id\x18\x01 \x01(\tR\vcontainerId\x12%\n" +
	"\x0econtainer_name\x18\x02 \x01(\tR\rcontainerName\x12*\n" +
	"\x11cpu_usage_percent\x18\x03 \x01(\x01R\x0fcpuUsagePercent\x129\n" +
	"\x19cpu_usage_percent_display\x18\x04 \x01(\tR\x16cpuUsagePercentDisplay\x12&\n" +
	"\x0fcpu_usage_total\x18\x05 \x01(\x03R\rcpuUsageTotal\x125\n" +
	"\x17cpu_usage_total_display\x18\x06 \x01(\tR\x14cpuUsageTotalDisplay\x12!\n" +
	"\fmemory_usage\x18\a \x01(\x03R\vmemoryUsage\x120\n" +
	"\x14memory_usage_display\x18\b \x01(\tR\x12memoryUsageDisplay\x12!\n" +
	"\fmemory_limit\x18\t \x01(\x03R\vmemoryLimit\x120\n" +
	"\x14memory_limit_display\x18\n" +
	" \x01(\tR\x12memoryLimitDisplay\x120\n" +
	"\x14memory_usage_percent\x18\v \x01(\x01R\x12memoryUsagePercent\x12?\n" +
	"\x1cmemory_usage_percent_display\x18\f \x01(\tR\x19memoryUsagePercentDisplay\x12(\n" +
	"\x10network_rx_bytes\x18\r \x01(\x03R\x0enetworkRxBytes\x127\n" +
	"\x18network_rx_bytes_display\x18\x0e \x01(\tR\x15networkRxBytesDisplay\x12(\n" +
	"\x10network_tx_bytes\x18\x0f \x01(\x03R\x0enetworkTxBytes\x127\n" +
	"\x18network_tx_bytes_display\x18\x10 \x01(\tR\x15networkTxBytesDisplay\x12,\n" +
	"\x12storage_read_bytes\x18\x11 \x01(\x03R\x10storageReadBytes\x12;\n" +
	"\x1astorage_read_bytes_display\x18\x12 \x01(\tR\x17storageReadBytesDisplay\x12.\n" +
	"\x13storage_write_bytes\x18\x13 \x01(\x03R\x11storageWriteBytes\x12=\n" +
	"\x1bstorage_write_bytes_display\x18\x14 \x01(\tR\x18storageWriteBytesDisplay\x12\x1c\n" +
	"\ttimestamp\x18\x15 \x01(\tR\ttimestamp\"\xae\x01\n" +
	...
	"references\x12'\n" +
	"\x0finclude_digests\x18\x04 \x01(\bR\x0eincludeDigests\"O\n" +
	"\rListImagesRes\x12(\n" +
	...
	"\fsize_display\x18\x05 \x01(\tR\vsizeDisplay\x12\x1d\n" +
	"\n" +
