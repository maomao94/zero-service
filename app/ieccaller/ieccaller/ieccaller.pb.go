...
type SendCommandReq struct {
	...
	Port          uint32                 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
	Coa           uint32                 `protobuf:"varint,3,opt,name=coa,proto3" json:"coa,omitempty"`
	TypeId        uint32                 `protobuf:"varint,4,opt,name=type_id,json=typeId,proto3" json:"type_id,omitempty"` // 指令类型，例如 45=C_SC_NA_1, 46=C_DC_NA_1 ...
...
type SendSingleCommandReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"` // true=带CP56Time2a时标(C_SC_TA_1=58), false=不带(C_SC_NA_1=45)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendDoubleCommandReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"`             // true=带CP56Time2a时标(C_DC_TA_1=59), false=不带(C_DC_NA_1=46)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendStepCommandReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"`           // true=带CP56Time2a时标(C_RC_TA_1=60), false=不带(C_RC_NA_1=47)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendSetpointNormalizedReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"` // true=带CP56Time2a时标(C_SE_TA_1=61), false=不带(C_SE_NA_1=48)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendSetpointScaledReq struct {
	...
	Ioa           uint32                 `protobuf:"varint,4,opt,name=ioa,proto3" json:"ioa,omitempty"`
	Value         int32                  `protobuf:"varint,5,opt,name=value,proto3" json:"value,omitempty"`
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"` // true=带CP56Time2a时标(C_SE_TB_1=62), false=不带(C_SE_NB_1=49)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendSetpointFloatReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"` // true=带CP56Time2a时标(C_SE_TC_1=63), false=不带(C_SE_NC_1=50)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SendBitstringCommandReq struct {
	...
	WithTime      bool                   `protobuf:"varint,6,opt,name=with_time,json=withTime,proto3" json:"with_time,omitempty"` // true=带CP56Time2a时标(C_BO_TA_1=64), false=不带(C_BO_NA_1=51)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PbDevicePointMapping struct {
	...
	TagStation    string                 `protobuf:"bytes,4,opt,name=tag_station,json=tagStation,proto3" json:"tag_station,omitempty"`
	...
	TdTableType   string                 `protobuf:"bytes,9,opt,name=td_table_type,json=tdTableType,proto3" json:"td_table_type,omitempty"`
	EnablePush    int32                  `protobuf:"varint,10,opt,name=enable_push,json=enablePush,proto3" json:"enable_push,omitempty"` // 0: 禁用推送, 1: 启用推送
...
type QueryPointMappingByKeyReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TagStation    string                 `protobuf:"bytes,1,opt,name=tag_station,json=tagStation,proto3" json:"tag_station,omitempty"`
...
type PageListPointMappingReq struct {
	...
	TagStation    string                 `protobuf:"bytes,3,opt,name=tag_station,json=tagStation,proto3" json:"tag_station,omitempty"`
...
type ClearPointMappingCacheReq struct {
	...
	KeyInfos      []*CacheKeyInfo        `protobuf:"bytes,2,rep,name=key_infos,json=keyInfos,proto3" json:"key_infos,omitempty"` // 缓存key信息列表，用于根据tagStation、coa、ioa生成key
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ClearPointMappingCacheRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClearedCount  int64                  `protobuf:"varint,1,opt,name=cleared_count,json=clearedCount,proto3" json:"cleared_count,omitempty"` // 清除的缓存数量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_ieccaller_proto_rawDesc = "" +
	...
	"\x1eSendCounterInterrogationCmdRes\"\x8b\x01\n" +
	"\x0eSendCommandReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x17\n" +
	"\atype_id\x18\x04 \x01(\rR\x06typeId\x12\x10\n" +
	...
	"\x05value\x18\x01 \x01(\x04R\x05value\"\x95\x01\n" +
	"\x14SendSingleCommandReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x10\n" +
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x12\x14\n" +
	"\x05value\x18\x05 \x01(\bR\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\xb4\x01\n" +
	"\x14SendDoubleCommandReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x10\n" +
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x123\n" +
	"\x05value\x18\x05 \x01(\x0e2\x1d.ieccaller.DoubleCommandValueR\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\xb0\x01\n" +
	"\x12SendStepCommandReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x10\n" +
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x121\n" +
	"\x05value\x18\x05 \x01(\x0e2\x1b.ieccaller.StepCommandValueR\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\x9a\x01\n" +
	"\x19SendSetpointNormalizedReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x10\n" +
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x12\x14\n" +
	"\x05value\x18\x05 \x01(\x05R\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\x96\x01\n" +
	...
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x12\x14\n" +
	"\x05value\x18\x05 \x01(\x05R\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\x95\x01\n" +
	...
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\x98\x01\n" +
	"\x17SendBitstringCommandReq\x12\x12\n" +
	"\x04host\x18\x01 \x01(\tR\x04host\x12\x12\n" +
	"\x04port\x18\x02 \x01(\rR\x04port\x12\x10\n" +
	"\x03coa\x18\x03 \x01(\rR\x03coa\x12\x10\n" +
	"\x03ioa\x18\x04 \x01(\rR\x03ioa\x12\x14\n" +
	"\x05value\x18\x05 \x01(\x04R\x05value\x12\x1b\n" +
	"\twith_time\x18\x06 \x01(\bR\bwithTime\"\xb6\x03\n" +
	...
	"updateTime\x12\x1f\n" +
	"\vtag_station\x18\x04 \x01(\tR\n" +
	"tagStation\x12\x10\n" +
	"\x03coa\x18\x05 \x01(\x03R\x03coa\x12\x10\n" +
	"\x03ioa\x18\x06 \x01(\x03R\x03ioa\x12\x1b\n" +
	"\tdevice_id\x18\a \x01(\tR\bdeviceId\x12\x1f\n" +
	"\vdevice_name\x18\b \x01(\tR\n" +
	"deviceName\x12\"\n" +
	"\rtd_table_type\x18\t \x01(\tR\vtdTableType\x12\x1f\n" +
	"\venable_push\x18\n" +
	" \x01(\x05R\n" +
	"enablePush\x12 \n" +
	...
	"\amapping\x18\x01 \x01(\v2\x1f.ieccaller.PbDevicePointMappingR\amapping\"`\n" +
	"\x19QueryPointMappingByKeyReq\x12\x1f\n" +
	"\vtag_station\x18\x01 \x01(\tR\n" +
	"tagStation\x12\x10\n" +
	"\x03coa\x18\x02 \x01(\x03R\x03coa\x12\x10\n" +
	"\x03ioa\x18\x03 \x01(\x03R\x03ioa\"V\n" +
	"\x19QueryPointMappingByKeyRes\x129\n" +
	"\amapping\x18\x01 \x01(\v2\x1f.ieccaller.PbDevicePointMappingR\amapping\"\x9a\x01\n" +
	"\x17PageListPointMappingReq\x12\x12\n" +
	"\x04page\x18\x01 \x01(\x03R\x04page\x12\x1b\n" +
	"\tpage_size\x18\x02 \x01(\x03R\bpageSize\x12\x1f\n" +
	"\vtag_station\x18\x03 \x01(\tR\n" +
	"tagStation\x12\x10\n" +
	"\x03coa\x18\x04 \x01(\x03R\x03coa\x12\x1b\n" +
	"\tdevice_id\x18\x05 \x01(\tR\bdeviceId\"l\n" +
	"\x17PageListPointMappingRes\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05total\x12;\n" +
	"\bmappings\x18\x02 \x03(\v2\x1f.ieccaller.PbDevicePointMappingR\bmappings\"e\n" +
	"\x19ClearPointMappingCacheReq\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\tR\x04keys\x124\n" +
	"\tkey_infos\x18\x02 \x03(\v2\x17.ieccaller.CacheKeyInfoR\bkeyInfos\"S\n" +
	"\fCacheKeyInfo\x12\x1f\n" +
	"\vtag_station\x18\x01 \x01(\tR\n" +
	"tagStation\x12\x10\n" +
	"\x03coa\x18\x02 \x01(\x03R\x03coa\x12\x10\n" +
	"\x03ioa\x18\x03 \x01(\x03R\x03ioa\"@\n" +
	"\x19ClearPointMappingCacheRes\x12#\n" +
	"\rcleared_count\x18\x01 \x01(\x03R\fclearedCount*B\n" +
...
var file_ieccaller_proto_depIdxs = []int32{
	...
	36, // 6: ieccaller.ClearPointMappingCacheReq.key_infos:type_name -> ieccaller.CacheKeyInfo
