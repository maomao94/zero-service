...
func (s *TriggerRpcServer) DeleteCronJobs(ctx context.Context, in *trigger.DeleteCronJobsReq) (*trigger.DeleteCronJobsRes, error) {
	l := logic.NewDeleteCronJobsLogic(ctx, s.svcCtx)
	return l.DeleteCronJobs(in)
}

// 按任务分组批量软删除 Cron Job，重复删除按幂等成功处理
func (s *TriggerRpcServer) DeleteCronJobsByGroup(ctx context.Context, in *trigger.DeleteCronJobsByGroupReq) (*trigger.DeleteCronJobsByGroupRes, error) {
	l := logic.NewDeleteCronJobsByGroupLogic(ctx, s.svcCtx)
	return l.DeleteCronJobsByGroup(in)
}
