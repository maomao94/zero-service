...
func (x *CreatePlanExecItem) GetServiceAddr() string {
	if x != nil {
...
type PbPlanExecItem struct {
	...
	// 业务服务地址
	ServiceAddr string `protobuf:"bytes,11,opt,name=serviceAddr,proto3" json:"serviceAddr,omitempty"`
	// 业务负载
	...
	// 终止时间
	TerminatedTime string `protobuf:"bytes,22,opt,name=terminatedTime,proto3" json:"terminatedTime,omitempty"`
	// 终止原因
	TerminatedReason string `protobuf:"bytes,23,opt,name=terminatedReason,proto3" json:"terminatedReason,omitempty"`
	// 暂停时间
	PausedTime string `protobuf:"bytes,24,opt,name=pausedTime,proto3" json:"pausedTime,omitempty"`
	// 暂停原因
	PausedReason string `protobuf:"bytes,25,opt,name=pausedReason,proto3" json:"pausedReason,omitempty"`
	// 扩展字段1
	Ext1 string `protobuf:"bytes,26,opt,name=ext1,proto3" json:"ext1,omitempty"`
	// 扩展字段2
	Ext2 string `protobuf:"bytes,27,opt,name=ext2,proto3" json:"ext2,omitempty"`
	// 扩展字段3
	Ext3 string `protobuf:"bytes,28,opt,name=ext3,proto3" json:"ext3,omitempty"`
	// 扩展字段4
	Ext4 string `protobuf:"bytes,29,opt,name=ext4,proto3" json:"ext4,omitempty"`
	// 扩展字段5
	Ext5          string `protobuf:"bytes,30,opt,name=ext5,proto3" json:"ext5,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CallbackPlanExecItemReq struct {
	...
	// 延期配置：delayed-自定义延期
	DelayConfig   *PbDelayConfig `protobuf:"bytes,5,opt,name=delayConfig,proto3" json:"delayConfig,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_trigger_proto_rawDesc = "" +
	...
	"\b\x01\"\x06\x1a\x04\x18;(\x00R\aminutes\"\xd8\x02\n" +
	...
	"\apointId\x18\x04 \x01(\tR\apointId\x12)\n" +
	"\vserviceAddr\x18\x05 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\vserviceAddr\x12\x18\n" +
	"\apayload\x18\x06 \x01(\tR\apayload\x12&\n" +
	"\x0erequestTimeout\x18\a \x01(\x03R\x0erequestTimeout\x12\x12\n" +
	"\x04ext1\x182 \x01(\tR\x04ext1\x12\x12\n" +
	"\x04ext2\x183 \x01(\tR\x04ext2\x12\x12\n" +
	"\x04ext3\x184 \x01(\tR\x04ext3\x12\x12\n" +
	"\x04ext4\x185 \x01(\tR\x04ext4\x12\x12\n" +
	...
	"\aexecCnt\x18\x04 \x01(\x03R\aexecCnt\"\x8a\x01\n" +
	"\fPausePlanReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x1f\n" +
	"\x06planId\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x06planId\x12 \n" +
	"\x06reason\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x06reason\"\x0e\n" +
	"\fPausePlanRes\"\x8e\x01\n" +
	"\x10TerminatePlanReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x1f\n" +
	"\x06planId\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x06planId\x12 \n" +
	"\x06reason\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x06reason\"\x12\n" +
	"\x10TerminatePlanRes\"i\n" +
	"\rResumePlanReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x1f\n" +
	"\x06planId\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x06planId\"\x0f\n" +
	"\rResumePlanRes\"\x87\x01\n" +
	...
	"\x06reason\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x06reason\"\x13\n" +
	"\x11PausePlanBatchRes\"\x8b\x01\n" +
	"\x15TerminatePlanBatchReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02(\x01R\x02id\x12 \n" +
	"\x06reason\x18\x02 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x06reason\"\x17\n" +
	"\x15TerminatePlanBatchRes\"f\n" +
	"\x12ResumePlanBatchReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02(\x01R\x02id\"\x14\n" +
	"\x12ResumePlanBatchRes\"\x8a\x01\n" +
	...
	"\x18TerminatePlanExecItemRes\"i\n" +
	"\x15ResumePlanExecItemReq\x127\n" +
	"\vcurrentUser\x18d \x01(\v2\x15.extproto.CurrentUserR\vcurrentUser\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02(\x01R\x02id\"\x17\n" +
	"\x15ResumePlanExecItemRes\"f\n" +
	...
	"\n" +
	"GetPlanRes\x12#\n" +
	"\x04plan\x18\x01 \x01(\v2\x0f.trigger.PbPlanR\x04plan\"\xad\x05\n" +
	"\x06PbPlan\x12\x1e\n" +
	"\n" +
	...
	"pausedTime\x12\"\n" +
	"\fpausedReason\x18\r \x01(\tR\fpausedReason\x12\x12\n" +
	...
	"\fplanExecItem\x18\x01 \x03(\v2\x17.trigger.PbPlanExecItemR\fplanExecItem\"\x9e\b\n" +
	...
	"\aPointId\x18\n" +
	" \x01(\tR\aPointId\x12 \n" +
	"\vserviceAddr\x18\v \x01(\tR\vserviceAddr\x12\x18\n" +
	...
	"\ftriggerCount\x18\x11 \x01(\x05R\ftriggerCount\x12\x16\n" +
	...
	"lastReason\x12&\n" +
	"\x0eterminatedTime\x18\x16 \x01(\tR\x0eterminatedTime\x12*\n" +
	"\x10terminatedReason\x18\x17 \x01(\tR\x10terminatedReason\x12\x1e\n" +
	"\n" +
	"pausedTime\x18\x18 \x01(\tR\n" +
	"pausedTime\x12\"\n" +
	"\fpausedReason\x18\x19 \x01(\tR\fpausedReason\x12\x12\n" +
	"\x04ext1\x18\x1a \x01(\tR\x04ext1\x12\x12\n" +
	"\x04ext2\x18\x1b \x01(\tR\x04ext2\x12\x12\n" +
	"\x04ext3\x18\x1c \x01(\tR\x04ext3\x12\x12\n" +
	"\x04ext4\x18\x1d \x01(\tR\x04ext4\x12\x12\n" +
	"\x04ext5\x18\x1e \x01(\tR\x04ext5\"\xc6\x02\n" +
	...
	"\vdelayConfig\x18\x05 \x01(\v2\x16.trigger.PbDelayConfigR\vdelayConfig\"[\n" +
	"\rPbDelayConfig\x12(\n" +
