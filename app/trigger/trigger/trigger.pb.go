...
type CreatePlanExecItem struct {
	...
	// 间隔时间 单位: 毫秒
	IntervalTime int64 `protobuf:"varint,8,opt,name=intervalTime,proto3" json:"intervalTime,omitempty"`
	// 间隔类型 0-不间隔（同时发起） 1-往后顺延 2-间隔时间内偏移
	IntervalType int32 `protobuf:"varint,9,opt,name=intervalType,proto3" json:"intervalType,omitempty"`
	// 扩展字段
	Ext1          string `protobuf:"bytes,50,opt,name=ext1,proto3" json:"ext1,omitempty"`
	Ext2          string `protobuf:"bytes,51,opt,name=ext2,proto3" json:"ext2,omitempty"`
	Ext3          string `protobuf:"bytes,52,opt,name=ext3,proto3" json:"ext3,omitempty"`
...
type PbPlanExecItem struct {
	...
	// 间隔时间 单位: 毫秒
	IntervalTime int64 `protobuf:"varint,14,opt,name=intervalTime,proto3" json:"intervalTime,omitempty"`
	// 间隔类型 0-不间隔（同时发起） 1-往后顺延 2-间隔时间内偏移
	IntervalType int32 `protobuf:"varint,15,opt,name=intervalType,proto3" json:"intervalType,omitempty"`
	// 偏移百分比（0-100），仅当 intervalType=2 时生效
	OffsetPercent int32 `protobuf:"varint,16,opt,name=offsetPercent,proto3" json:"offsetPercent,omitempty"`
	// 计划触发时间
	PlanTriggerTime string `protobuf:"bytes,17,opt,name=planTriggerTime,proto3" json:"planTriggerTime,omitempty"`
	// 下次触发时间
	NextTriggerTime string `protobuf:"bytes,18,opt,name=nextTriggerTime,proto3" json:"nextTriggerTime,omitempty"`
	// 上次触发时间
	LastTriggerTime string `protobuf:"bytes,19,opt,name=lastTriggerTime,proto3" json:"lastTriggerTime,omitempty"`
	// 触发次数
	TriggerCount int32 `protobuf:"varint,20,opt,name=triggerCount,proto3" json:"triggerCount,omitempty"`
	// 状态：0-待执行，1-执行中，2-完成，3-失败，4-延期，5-已终止，6-暂停
	Status int32 `protobuf:"varint,21,opt,name=status,proto3" json:"status,omitempty"`
	// 上次执行结果
	LastResult string `protobuf:"bytes,22,opt,name=lastResult,proto3" json:"lastResult,omitempty"`
	// 上次结果描述
	...
	// 扩展字段2
	Ext2 string `protobuf:"bytes,30,opt,name=ext2,proto3" json:"ext2,omitempty"`
	// 扩展字段3
	Ext3 string `protobuf:"bytes,31,opt,name=ext3,proto3" json:"ext3,omitempty"`
	// 扩展字段4
	Ext4 string `protobuf:"bytes,32,opt,name=ext4,proto3" json:"ext4,omitempty"`
	// 扩展字段5
	Ext5          string `protobuf:"bytes,33,opt,name=ext5,proto3" json:"ext5,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_trigger_proto_rawDesc = "" +
	...
	"\b\x01\"\x06\x1a\x04\x18;(\x00R\aminutes\"\xb4\x03\n" +
	...
	"\x0erequestTimeout\x18\a \x01(\x03R\x0erequestTimeout\x12+\n" +
	"\fintervalTime\x18\b \x01(\x03B\a\xfaB\x04\"\x02(\x00R\fintervalTime\x12-\n" +
	"\fintervalType\x18\t \x01(\x05B\t\xfaB\x06\x1a\x04\x18\x02(\x00R\fintervalType\x12\x12\n" +
	"\x04ext1\x182 \x01(\tR\x04ext1\x12\x12\n" +
	"\x04ext2\x183 \x01(\tR\x04ext2\x12\x12\n" +
	"\x04ext3\x184 \x01(\tR\x04ext3\x12\x12\n" +
	"\x04ext4\x185 \x01(\tR\x04ext4\x12\x12\n" +
	...
	"\fintervalTime\x18\x0e \x01(\x03R\fintervalTime\x12\"\n" +
	"\fintervalType\x18\x0f \x01(\x05R\fintervalType\x12$\n" +
	"\roffsetPercent\x18\x10 \x01(\x05R\roffsetPercent\x12(\n" +
	"\x0fplanTriggerTime\x18\x11 \x01(\tR\x0fplanTriggerTime\x12(\n" +
	"\x0fnextTriggerTime\x18\x12 \x01(\tR\x0fnextTriggerTime\x12(\n" +
	"\x0flastTriggerTime\x18\x13 \x01(\tR\x0flastTriggerTime\x12\"\n" +
	"\ftriggerCount\x18\x14 \x01(\x05R\ftriggerCount\x12\x16\n" +
	"\x06status\x18\x15 \x01(\x05R\x06status\x12\x1e\n" +
	"\n" +
	"lastResult\x18\x16 \x01(\tR\n" +
	"lastResult\x12 \n" +
	...
	"\x04ext4\x18  \x01(\tR\x04ext4\x12\x12\n" +
	"\x04ext5\x18! \x01(\tR\x04ext5\"\xc6\x02\n" +
