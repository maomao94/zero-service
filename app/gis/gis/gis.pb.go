...
type Ring struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Points        []*Point               `protobuf:"bytes,1,rep,name=points,proto3" json:"points,omitempty"` // 环顶点（至少 3 个点，自动首尾闭合）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Polygon struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Outer         *Ring                  `protobuf:"bytes,1,opt,name=outer,proto3" json:"outer,omitempty"` // 外环，定义围栏边界
	Holes         []*Ring                `protobuf:"bytes,2,rep,name=holes,proto3" json:"holes,omitempty"` // 洞/内环，命中判断和 cells 覆盖时从外环中排除。洞必须完全在外环内部，超出或洞相交会被拒绝。
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Fence struct {
	...
	Polygon       *Polygon               `protobuf:"bytes,2,opt,name=polygon,proto3" json:"polygon,omitempty"`                // 围栏多边形（主动判断时必填；outer 为外环，holes 为排除区域）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Fence) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
type GenFenceCellsReq struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Polygon          *Polygon               `protobuf:"bytes,1,opt,name=polygon,proto3" json:"polygon,omitempty"`                                            // 围栏多边形；outer 为外环，holes 为排除区域
...
func (x *GenFenceCellsReq) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
func (x *GenFenceH3CellsReq) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
type CreateFenceReq struct {
	...
	Polygon          *Polygon               `protobuf:"bytes,2,opt,name=polygon,proto3" json:"polygon,omitempty"`                                            // 围栏多边形；outer 为外环，holes 为排除区域
...
func (x *CreateFenceReq) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
type UpdateFenceReq struct {
	...
	Polygon          *Polygon               `protobuf:"bytes,3,opt,name=polygon,proto3" json:"polygon,omitempty"`                                            // 新围栏多边形；outer 为外环，holes 为排除区域
...
func (x *UpdateFenceReq) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
type FenceDetail struct {
	...
	Polygon          *Polygon               `protobuf:"bytes,3,opt,name=polygon,proto3" json:"polygon,omitempty"`                                            // 围栏多边形；outer 为外环，holes 为排除区域
...
func (x *FenceDetail) GetPolygon() *Polygon {
	if x != nil {
		return x.Polygon
	}
	return nil
...
const file_gis_proto_rawDesc = "" +
	...
	".gis.PointR\x06points\"K\n" +
	"\aPolygon\x12\x1f\n" +
	"\x05outer\x18\x01 \x01(\v2\t.gis.RingR\x05outer\x12\x1f\n" +
	"\x05holes\x18\x02 \x03(\v2\t.gis.RingR\x05holes\"J\n" +
	"\x05Fence\x12\x19\n" +
	"\bfence_id\x18\x01 \x01(\tR\afenceId\x12&\n" +
	"\apolygon\x18\x02 \x01(\v2\f.gis.PolygonR\apolygon\"R\n" +
	...
	"\x05cells\x18\x02 \x03(\v2\x11.gis.GridDiskCellR\x05cells\"\x85\x01\n" +
	"\x10GenFenceCellsReq\x12&\n" +
	"\apolygon\x18\x01 \x01(\v2\f.gis.PolygonR\apolygon\x12\x1c\n" +
	...
	"\apolygon\x18\x01 \x01(\v2\f.gis.PolygonR\apolygon\x12\x1e\n" +
	"\n" +
	"resolution\x18\x02 \x01(\rR\n" +
	"resolution\"3\n" +
	...
	"visitOrder\x122\n" +
	"\x15total_distance_meters\x18\x02 \x01(\x01R\x13totalDistanceMeters\"\x9e\x01\n" +
	"\x0eCreateFenceReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\apolygon\x18\x02 \x01(\v2\f.gis.PolygonR\apolygon\x12#\n" +
	...
	"\tgeohashes\x18\x03 \x03(\tR\tgeohashes\"\xb9\x01\n" +
	"\x0eUpdateFenceReq\x12\x19\n" +
	"\bfence_id\x18\x01 \x01(\tR\afenceId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12&\n" +
	"\apolygon\x18\x03 \x01(\v2\f.gis.PolygonR\apolygon\x12#\n" +
	...
	"\vGetFenceRes\x12&\n" +
	"\x05fence\x18\x01 \x01(\v2\x10.gis.FenceDetailR\x05fence\"\xad\x02\n" +
	...
	"\x0fCOORD_TYPE_BD09\x10\x032\xbd\v\n" +
	"\x03Gis\x12=\n" +
...
var file_gis_proto_goTypes = []any{
	...
	(*Ring)(nil),                   // 3: gis.Ring
	(*Polygon)(nil),                // 4: gis.Polygon
	(*Fence)(nil),                  // 5: gis.Fence
...
var file_gis_proto_depIdxs = []int32{
	...
	1,  // 2: gis.Ring.points:type_name -> gis.Point
	3,  // 3: gis.Polygon.outer:type_name -> gis.Ring
	3,  // 4: gis.Polygon.holes:type_name -> gis.Ring
	4,  // 5: gis.Fence.polygon:type_name -> gis.Polygon
	1,  // 6: gis.EncodeGeoHashReq.point:type_name -> gis.Point
	1,  // 7: gis.EncodeGeoHashMultiReq.point:type_name -> gis.Point
	8,  // 8: gis.EncodeGeoHashMultiRes.geohashes:type_name -> gis.GeoHashIndex
	1,  // 9: gis.DecodeGeoHashRes.point:type_name -> gis.Point
	1,  // 10: gis.EncodeH3Req.point:type_name -> gis.Point
	1,  // 11: gis.EncodeH3MultiReq.point:type_name -> gis.Point
	15, // 12: gis.EncodeH3MultiRes.h3_indexes:type_name -> gis.H3Index
	1,  // 13: gis.DecodeH3Res.center:type_name -> gis.Point
	1,  // 14: gis.DecodeH3Res.boundary:type_name -> gis.Point
	1,  // 15: gis.GridDiskByPointReq.point:type_name -> gis.Point
	22, // 16: gis.GridDiskRes.cells:type_name -> gis.GridDiskCell
	4,  // 17: gis.GenFenceCellsReq.polygon:type_name -> gis.Polygon
	4,  // 18: gis.GenFenceH3CellsReq.polygon:type_name -> gis.Polygon
	1,  // 19: gis.PointsWithinRadiusReq.center:type_name -> gis.Point
	1,  // 20: gis.PointsWithinRadiusReq.points:type_name -> gis.Point
	29, // 21: gis.PointsWithinRadiusRes.hits:type_name -> gis.RadiusHit
	1,  // 22: gis.PointInFenceReq.point:type_name -> gis.Point
	5,  // 23: gis.PointInFenceReq.fence:type_name -> gis.Fence
	1,  // 24: gis.PointInFencesReq.point:type_name -> gis.Point
	5,  // 25: gis.PointInFencesReq.fences:type_name -> gis.Fence
	1,  // 26: gis.DistanceReq.a:type_name -> gis.Point
	1,  // 27: gis.DistanceReq.b:type_name -> gis.Point
	2,  // 28: gis.BatchDistanceReq.pairs:type_name -> gis.PointPair
	1,  // 29: gis.NearbyFencesReq.point:type_name -> gis.Point
	1,  // 30: gis.TransformCoordReq.point:type_name -> gis.Point
	0,  // 31: gis.TransformCoordReq.source_type:type_name -> gis.CoordType
	0,  // 32: gis.TransformCoordReq.target_type:type_name -> gis.CoordType
	1,  // 33: gis.TransformCoordRes.transformed_point:type_name -> gis.Point
	1,  // 34: gis.BatchTransformCoordReq.points:type_name -> gis.Point
	0,  // 35: gis.BatchTransformCoordReq.source_type:type_name -> gis.CoordType
	0,  // 36: gis.BatchTransformCoordReq.target_type:type_name -> gis.CoordType
	1,  // 37: gis.BatchTransformCoordRes.transformed_points:type_name -> gis.Point
	1,  // 38: gis.RoutePointsReq.start:type_name -> gis.Point
	1,  // 39: gis.RoutePointsReq.points:type_name -> gis.Point
	4,  // 40: gis.CreateFenceReq.polygon:type_name -> gis.Polygon
	4,  // 41: gis.UpdateFenceReq.polygon:type_name -> gis.Polygon
	57, // 42: gis.ListFencesRes.list:type_name -> gis.FenceDetail
	57, // 43: gis.GetFenceRes.fence:type_name -> gis.FenceDetail
	4,  // 44: gis.FenceDetail.polygon:type_name -> gis.Polygon
	6,  // 45: gis.Gis.EncodeGeoHash:input_type -> gis.EncodeGeoHashReq
	9,  // 46: gis.Gis.EncodeGeoHashMulti:input_type -> gis.EncodeGeoHashMultiReq
	11, // 47: gis.Gis.DecodeGeoHash:input_type -> gis.DecodeGeoHashReq
	13, // 48: gis.Gis.EncodeH3:input_type -> gis.EncodeH3Req
	16, // 49: gis.Gis.EncodeH3Multi:input_type -> gis.EncodeH3MultiReq
	18, // 50: gis.Gis.DecodeH3:input_type -> gis.DecodeH3Req
	20, // 51: gis.Gis.GridDisk:input_type -> gis.GridDiskReq
	21, // 52: gis.Gis.GridDiskByPoint:input_type -> gis.GridDiskByPointReq
	24, // 53: gis.Gis.GenerateFenceCells:input_type -> gis.GenFenceCellsReq
	26, // 54: gis.Gis.GenerateFenceH3Cells:input_type -> gis.GenFenceH3CellsReq
	28, // 55: gis.Gis.PointsWithinRadius:input_type -> gis.PointsWithinRadiusReq
	31, // 56: gis.Gis.PointInFence:input_type -> gis.PointInFenceReq
	33, // 57: gis.Gis.PointInFences:input_type -> gis.PointInFencesReq
	35, // 58: gis.Gis.Distance:input_type -> gis.DistanceReq
	37, // 59: gis.Gis.BatchDistance:input_type -> gis.BatchDistanceReq
	39, // 60: gis.Gis.NearbyFences:input_type -> gis.NearbyFencesReq
	41, // 61: gis.Gis.TransformCoord:input_type -> gis.TransformCoordReq
	43, // 62: gis.Gis.BatchTransformCoord:input_type -> gis.BatchTransformCoordReq
	45, // 63: gis.Gis.RoutePoints:input_type -> gis.RoutePointsReq
	47, // 64: gis.Gis.CreateFence:input_type -> gis.CreateFenceReq
	49, // 65: gis.Gis.UpdateFence:input_type -> gis.UpdateFenceReq
	51, // 66: gis.Gis.DeleteFence:input_type -> gis.DeleteFenceReq
	53, // 67: gis.Gis.ListFences:input_type -> gis.ListFencesReq
	55, // 68: gis.Gis.GetFence:input_type -> gis.GetFenceReq
	7,  // 69: gis.Gis.EncodeGeoHash:output_type -> gis.EncodeGeoHashRes
	10, // 70: gis.Gis.EncodeGeoHashMulti:output_type -> gis.EncodeGeoHashMultiRes
	12, // 71: gis.Gis.DecodeGeoHash:output_type -> gis.DecodeGeoHashRes
	14, // 72: gis.Gis.EncodeH3:output_type -> gis.EncodeH3Res
	17, // 73: gis.Gis.EncodeH3Multi:output_type -> gis.EncodeH3MultiRes
	19, // 74: gis.Gis.DecodeH3:output_type -> gis.DecodeH3Res
	23, // 75: gis.Gis.GridDisk:output_type -> gis.GridDiskRes
	23, // 76: gis.Gis.GridDiskByPoint:output_type -> gis.GridDiskRes
	25, // 77: gis.Gis.GenerateFenceCells:output_type -> gis.GenFenceCellsRes
	27, // 78: gis.Gis.GenerateFenceH3Cells:output_type -> gis.GenFenceH3CellsRes
	30, // 79: gis.Gis.PointsWithinRadius:output_type -> gis.PointsWithinRadiusRes
	32, // 80: gis.Gis.PointInFence:output_type -> gis.PointInFenceRes
	34, // 81: gis.Gis.PointInFences:output_type -> gis.PointInFencesRes
	36, // 82: gis.Gis.Distance:output_type -> gis.DistanceRes
	38, // 83: gis.Gis.BatchDistance:output_type -> gis.BatchDistanceRes
	40, // 84: gis.Gis.NearbyFences:output_type -> gis.NearbyFencesRes
	42, // 85: gis.Gis.TransformCoord:output_type -> gis.TransformCoordRes
	44, // 86: gis.Gis.BatchTransformCoord:output_type -> gis.BatchTransformCoordRes
	46, // 87: gis.Gis.RoutePoints:output_type -> gis.RoutePointsRes
	48, // 88: gis.Gis.CreateFence:output_type -> gis.CreateFenceRes
	50, // 89: gis.Gis.UpdateFence:output_type -> gis.UpdateFenceRes
	52, // 90: gis.Gis.DeleteFence:output_type -> gis.DeleteFenceRes
	54, // 91: gis.Gis.ListFences:output_type -> gis.ListFencesRes
	56, // 92: gis.Gis.GetFence:output_type -> gis.GetFenceRes
