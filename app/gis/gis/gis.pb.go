...
type PointsWithinRadiusRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HitIndexes    []int32                `protobuf:"varint,1,rep,packed,name=hit_indexes,json=hitIndexes,proto3" json:"hit_indexes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_gis_proto_rawDesc = "" +
	...
	"\bh3_index\x18\x01 \x01(\tR\ah3Index\"(\n" +
	...
	"\rradius_meters\x18\x03 \x01(\x01R\fradiusMeters\"8\n" +
	"\x15PointsWithinRadiusRes\x12\x1f\n" +
	"\vhit_indexes\x18\x01 \x03(\x05R\n" +
	"hitIndexes\"U\n" +
	...
	"\x0fCOORD_TYPE_BD09\x10\x032\xde\t\n" +
	"\x03Gis\x12\x1a\n" +
...
var file_gis_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_gis_proto_goTypes = []any{
	...
	(*DecodeGeoHashReq)(nil),       // 8: gis.DecodeGeoHashReq
	(*DecodeGeoHashRes)(nil),       // 9: gis.DecodeGeoHashRes
	(*EncodeH3Req)(nil),            // 10: gis.EncodeH3Req
	(*EncodeH3Res)(nil),            // 11: gis.EncodeH3Res
	(*DecodeH3Req)(nil),            // 12: gis.DecodeH3Req
	(*DecodeH3Res)(nil),            // 13: gis.DecodeH3Res
	(*GenFenceCellsReq)(nil),       // 14: gis.GenFenceCellsReq
	(*GenFenceCellsRes)(nil),       // 15: gis.GenFenceCellsRes
	(*GenFenceH3CellsReq)(nil),     // 16: gis.GenFenceH3CellsReq
	(*GenFenceH3CellsRes)(nil),     // 17: gis.GenFenceH3CellsRes
	(*PointsWithinRadiusReq)(nil),  // 18: gis.PointsWithinRadiusReq
	(*PointsWithinRadiusRes)(nil),  // 19: gis.PointsWithinRadiusRes
	(*PointInFenceReq)(nil),        // 20: gis.PointInFenceReq
	(*PointInFenceRes)(nil),        // 21: gis.PointInFenceRes
	(*PointInFencesReq)(nil),       // 22: gis.PointInFencesReq
	(*PointInFencesRes)(nil),       // 23: gis.PointInFencesRes
	(*DistanceReq)(nil),            // 24: gis.DistanceReq
	(*DistanceRes)(nil),            // 25: gis.DistanceRes
	(*BatchDistanceReq)(nil),       // 26: gis.BatchDistanceReq
	(*BatchDistanceRes)(nil),       // 27: gis.BatchDistanceRes
	(*NearbyFencesReq)(nil),        // 28: gis.NearbyFencesReq
	(*NearbyFencesRes)(nil),        // 29: gis.NearbyFencesRes
	(*TransformCoordReq)(nil),      // 30: gis.TransformCoordReq
	(*TransformCoordRes)(nil),      // 31: gis.TransformCoordRes
	(*BatchTransformCoordReq)(nil), // 32: gis.BatchTransformCoordReq
	(*BatchTransformCoordRes)(nil), // 33: gis.BatchTransformCoordRes
	(*RoutePointsReq)(nil),         // 34: gis.RoutePointsReq
	(*RoutePointsRes)(nil),         // 35: gis.RoutePointsRes
	(*CreateFenceReq)(nil),         // 36: gis.CreateFenceReq
	(*CreateFenceRes)(nil),         // 37: gis.CreateFenceRes
	(*UpdateFenceReq)(nil),         // 38: gis.UpdateFenceReq
	(*UpdateFenceRes)(nil),         // 39: gis.UpdateFenceRes
	(*DeleteFenceReq)(nil),         // 40: gis.DeleteFenceReq
	(*DeleteFenceRes)(nil),         // 41: gis.DeleteFenceRes
	(*ListFencesReq)(nil),          // 42: gis.ListFencesReq
	(*ListFencesRes)(nil),          // 43: gis.ListFencesRes
	(*GetFenceReq)(nil),            // 44: gis.GetFenceReq
	(*GetFenceRes)(nil),            // 45: gis.GetFenceRes
	(*FenceDetail)(nil),            // 46: gis.FenceDetail
}
var file_gis_proto_depIdxs = []int32{
	...
	2,  // 4: gis.DecodeGeoHashRes.point:type_name -> gis.Point
	2,  // 5: gis.EncodeH3Req.point:type_name -> gis.Point
	2,  // 6: gis.DecodeH3Res.center:type_name -> gis.Point
	2,  // 7: gis.DecodeH3Res.boundary:type_name -> gis.Point
	2,  // 8: gis.GenFenceCellsReq.points:type_name -> gis.Point
	2,  // 9: gis.GenFenceH3CellsReq.points:type_name -> gis.Point
	2,  // 10: gis.PointsWithinRadiusReq.center:type_name -> gis.Point
	2,  // 11: gis.PointsWithinRadiusReq.points:type_name -> gis.Point
	2,  // 12: gis.PointInFenceReq.point:type_name -> gis.Point
	1,  // 13: gis.PointInFenceReq.fence:type_name -> gis.Fence
	2,  // 14: gis.PointInFencesReq.point:type_name -> gis.Point
	1,  // 15: gis.PointInFencesReq.fences:type_name -> gis.Fence
	2,  // 16: gis.DistanceReq.a:type_name -> gis.Point
	2,  // 17: gis.DistanceReq.b:type_name -> gis.Point
	3,  // 18: gis.BatchDistanceReq.pairs:type_name -> gis.PointPair
	2,  // 19: gis.NearbyFencesReq.point:type_name -> gis.Point
	2,  // 20: gis.TransformCoordReq.point:type_name -> gis.Point
	0,  // 21: gis.TransformCoordReq.source_type:type_name -> gis.CoordType
	0,  // 22: gis.TransformCoordReq.target_type:type_name -> gis.CoordType
	2,  // 23: gis.TransformCoordRes.transformed_point:type_name -> gis.Point
	2,  // 24: gis.BatchTransformCoordReq.points:type_name -> gis.Point
	0,  // 25: gis.BatchTransformCoordReq.source_type:type_name -> gis.CoordType
	0,  // 26: gis.BatchTransformCoordReq.target_type:type_name -> gis.CoordType
	2,  // 27: gis.BatchTransformCoordRes.transformed_points:type_name -> gis.Point
	2,  // 28: gis.RoutePointsReq.start:type_name -> gis.Point
	2,  // 29: gis.RoutePointsReq.points:type_name -> gis.Point
	2,  // 30: gis.CreateFenceReq.points:type_name -> gis.Point
	2,  // 31: gis.UpdateFenceReq.points:type_name -> gis.Point
	46, // 32: gis.ListFencesRes.list:type_name -> gis.FenceDetail
	46, // 33: gis.GetFenceRes.fence:type_name -> gis.FenceDetail
	2,  // 34: gis.FenceDetail.points:type_name -> gis.Point
	4,  // 35: gis.Gis.Ping:input_type -> gis.Req
	6,  // 36: gis.Gis.EncodeGeoHash:input_type -> gis.EncodeGeoHashReq
	8,  // 37: gis.Gis.DecodeGeoHash:input_type -> gis.DecodeGeoHashReq
	10, // 38: gis.Gis.EncodeH3:input_type -> gis.EncodeH3Req
	12, // 39: gis.Gis.DecodeH3:input_type -> gis.DecodeH3Req
	14, // 40: gis.Gis.GenerateFenceCells:input_type -> gis.GenFenceCellsReq
	16, // 41: gis.Gis.GenerateFenceH3Cells:input_type -> gis.GenFenceH3CellsReq
	18, // 42: gis.Gis.PointsWithinRadius:input_type -> gis.PointsWithinRadiusReq
	20, // 43: gis.Gis.PointInFence:input_type -> gis.PointInFenceReq
	22, // 44: gis.Gis.PointInFences:input_type -> gis.PointInFencesReq
	24, // 45: gis.Gis.Distance:input_type -> gis.DistanceReq
	26, // 46: gis.Gis.BatchDistance:input_type -> gis.BatchDistanceReq
	28, // 47: gis.Gis.NearbyFences:input_type -> gis.NearbyFencesReq
	30, // 48: gis.Gis.TransformCoord:input_type -> gis.TransformCoordReq
	32, // 49: gis.Gis.BatchTransformCoord:input_type -> gis.BatchTransformCoordReq
	34, // 50: gis.Gis.RoutePoints:input_type -> gis.RoutePointsReq
	36, // 51: gis.Gis.CreateFence:input_type -> gis.CreateFenceReq
	38, // 52: gis.Gis.UpdateFence:input_type -> gis.UpdateFenceReq
	40, // 53: gis.Gis.DeleteFence:input_type -> gis.DeleteFenceReq
	42, // 54: gis.Gis.ListFences:input_type -> gis.ListFencesReq
	44, // 55: gis.Gis.GetFence:input_type -> gis.GetFenceReq
	5,  // 56: gis.Gis.Ping:output_type -> gis.Res
	7,  // 57: gis.Gis.EncodeGeoHash:output_type -> gis.EncodeGeoHashRes
	9,  // 58: gis.Gis.DecodeGeoHash:output_type -> gis.DecodeGeoHashRes
	11, // 59: gis.Gis.EncodeH3:output_type -> gis.EncodeH3Res
	13, // 60: gis.Gis.DecodeH3:output_type -> gis.DecodeH3Res
	15, // 61: gis.Gis.GenerateFenceCells:output_type -> gis.GenFenceCellsRes
	17, // 62: gis.Gis.GenerateFenceH3Cells:output_type -> gis.GenFenceH3CellsRes
	19, // 63: gis.Gis.PointsWithinRadius:output_type -> gis.PointsWithinRadiusRes
	21, // 64: gis.Gis.PointInFence:output_type -> gis.PointInFenceRes
	23, // 65: gis.Gis.PointInFences:output_type -> gis.PointInFencesRes
	25, // 66: gis.Gis.Distance:output_type -> gis.DistanceRes
	27, // 67: gis.Gis.BatchDistance:output_type -> gis.BatchDistanceRes
	29, // 68: gis.Gis.NearbyFences:output_type -> gis.NearbyFencesRes
	31, // 69: gis.Gis.TransformCoord:output_type -> gis.TransformCoordRes
	33, // 70: gis.Gis.BatchTransformCoord:output_type -> gis.BatchTransformCoordRes
	35, // 71: gis.Gis.RoutePoints:output_type -> gis.RoutePointsRes
	37, // 72: gis.Gis.CreateFence:output_type -> gis.CreateFenceRes
	39, // 73: gis.Gis.UpdateFence:output_type -> gis.UpdateFenceRes
	41, // 74: gis.Gis.DeleteFence:output_type -> gis.DeleteFenceRes
	43, // 75: gis.Gis.ListFences:output_type -> gis.ListFencesRes
	45, // 76: gis.Gis.GetFence:output_type -> gis.GetFenceRes
