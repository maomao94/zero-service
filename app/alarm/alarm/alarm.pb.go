...
type AlarmReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChatName      string                 `protobuf:"bytes,1,opt,name=chat_name,json=chatName,proto3" json:"chat_name,omitempty"` // 服务告警 P0:线上事故处理 P1:线上事故处理 P2:线上事故处理 P3:线上事故处理 其他会新建群
	...
	DateTime      string                 `protobuf:"bytes,5,opt,name=date_time,json=dateTime,proto3" json:"date_time,omitempty"` // 2019-01-01 00:00:00
	AlarmId       string                 `protobuf:"bytes,6,opt,name=alarm_id,json=alarmId,proto3" json:"alarm_id,omitempty"`    // 唯一报警 id
	...
	UserId        []string               `protobuf:"bytes,9,rep,name=user_id,json=userId,proto3" json:"user_id,omitempty"`       // 报警人 userId
...
const file_alarm_proto_rawDesc = "" +
	...
	"\x03Res\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong\"\x8a\x02\n" +
	"\bAlarmReq\x12\x1b\n" +
	"\tchat_name\x18\x01 \x01(\tR\bchatName\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x18\n" +
	"\aproject\x18\x04 \x01(\tR\aproject\x12\x1b\n" +
	"\tdate_time\x18\x05 \x01(\tR\bdateTime\x12\x19\n" +
	"\balarm_id\x18\x06 \x01(\tR\aalarmId\x12\x18\n" +
	"\acontent\x18\a \x01(\tR\acontent\x12\x14\n" +
	"\x05error\x18\b \x01(\tR\x05error\x12\x17\n" +
	"\auser_id\x18\t \x03(\tR\x06userId\x12\x0e\n" +
	"\x02ip\x18\n" +
	" \x01(\tR\x02ip\"\n" +
	"\n" +
	"\bAlarmRes2R\n" +
