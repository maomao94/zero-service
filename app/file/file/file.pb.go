...
type ImageMeta struct {
	...
	BodySerialNumber string                 `protobuf:"bytes,8,opt,name=bodySerialNumber,proto3" json:"bodySerialNumber,omitempty"`                                                     // 机身序列号
...
type RelayTarget struct {
	...
	BucketName    string                 `protobuf:"bytes,3,opt,name=bucketName,proto3" json:"bucketName,omitempty"` // 存储桶名称
	Filename      string                 `protobuf:"bytes,4,opt,name=filename,proto3" json:"filename,omitempty"`     // 上传文件名
	PathPrefix    string                 `protobuf:"bytes,5,opt,name=pathPrefix,proto3" json:"pathPrefix,omitempty"` // 默认值 default 文件路径前缀
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RelayFileReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// source - 二选一
	SourceUrl     string         `protobuf:"bytes,1,opt,name=sourceUrl,proto3" json:"sourceUrl,omitempty"`     // OSS HTTP 地址
	SourcePath    string         `protobuf:"bytes,2,opt,name=sourcePath,proto3" json:"sourcePath,omitempty"`   // 本地磁盘文件路径
	Targets       []*RelayTarget `protobuf:"bytes,3,rep,name=targets,proto3" json:"targets,omitempty"`         // 目标 OSS 列表
	ContentType   string         `protobuf:"bytes,4,opt,name=contentType,proto3" json:"contentType,omitempty"` // 可选，不传则从源文件自动探测
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_file_proto_rawDesc = "" +
	...
	"\vcameraModel\x18\a \x01(\tR\vcameraModel\x12*\n" +
	"\x10bodySerialNumber\x18\b \x01(\tR\x10bodySerialNumber\x120\n" +
	...
	"pathPrefix\"\x9b\x01\n" +
	"\fRelayFileReq\x12\x1c\n" +
	"\tsourceUrl\x18\x01 \x01(\tR\tsourceUrl\x12\x1e\n" +
	"\n" +
	"sourcePath\x18\x02 \x01(\tR\n" +
	"sourcePath\x12+\n" +
	"\atargets\x18\x03 \x03(\v2\x11.file.RelayTargetR\atargets\x12 \n" +
	"\vcontentType\x18\x04 \x01(\tR\vcontentType\"0\n" +
	"\fRelayFileRes\x12 \n" +
	"\x05files\x18\x01 \x03(\v2\n" +
	".file.FileR\x05files\"x\n" +
	"\n" +
	"GetFileReq\x12\x1a\n" +
	"\btenantId\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1e\n" +
