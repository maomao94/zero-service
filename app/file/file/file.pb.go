...
type Oss struct {
	...
	OssCode       string                 `protobuf:"bytes,4,opt,name=oss_code,json=ossCode,proto3" json:"oss_code,omitempty"`          // 资源编号
	Endpoint      string                 `protobuf:"bytes,5,opt,name=endpoint,proto3" json:"endpoint,omitempty"`                       // 资源地址
	AccessKey     string                 `protobuf:"bytes,6,opt,name=access_key,json=accessKey,proto3" json:"access_key,omitempty"`    // accessKey
	SecretKey     string                 `protobuf:"bytes,7,opt,name=secret_key,json=secretKey,proto3" json:"secret_key,omitempty"`    // secretKey
	BucketName    string                 `protobuf:"bytes,8,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 空间名
	AppId         string                 `protobuf:"bytes,9,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`                // 应用ID TencentCOS需要
...
type File struct {
	...
	FormatSize    string                 `protobuf:"bytes,5,opt,name=format_size,json=formatSize,proto3" json:"format_size,omitempty"`       // 格式化文件大小
	OriginalName  string                 `protobuf:"bytes,6,opt,name=original_name,json=originalName,proto3" json:"original_name,omitempty"` // 初始文件名
	AttachId      string                 `protobuf:"bytes,7,opt,name=attach_id,json=attachId,proto3" json:"attach_id,omitempty"`             // 附件表ID
	...
	ThumbLink     string                 `protobuf:"bytes,10,opt,name=thumb_link,json=thumbLink,proto3" json:"thumb_link,omitempty"`         // 缩略图地址
	ThumbName     string                 `protobuf:"bytes,11,opt,name=thumb_name,json=ThumbName,proto3" json:"thumb_name,omitempty"`         // 缩略图文件名
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ImageMeta struct {
	...
	ImgHeight        int32                  `protobuf:"varint,4,opt,name=img_height,json=imgHeight,proto3" json:"img_height,omitempty"`                                                 // 高
	ImgWidth         int32                  `protobuf:"varint,5,opt,name=img_width,json=imgWidth,proto3" json:"img_width,omitempty"`                                                    // 宽
	Altitude         float64                `protobuf:"fixed64,6,opt,name=altitude,proto3" json:"altitude,omitempty"`                                                                   // 高度
	CameraModel      string                 `protobuf:"bytes,7,opt,name=camera_model,json=cameraModel,proto3" json:"camera_model,omitempty"`                                            // 相机型号
	BodySerialNumber string                 `protobuf:"bytes,8,opt,name=body_serial_number,json=bodySerialNumber,proto3" json:"body_serial_number,omitempty"`                           // 机身序列号
	Extra            map[string]string      `protobuf:"bytes,9,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 扩展元数据
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type OssFile struct {
	...
	FormatSize    string                 `protobuf:"bytes,4,opt,name=format_size,json=formatSize,proto3" json:"format_size,omitempty"`    // 格式化文件大小
	PutTime       string                 `protobuf:"bytes,5,opt,name=put_time,json=putTime,proto3" json:"put_time,omitempty"`             // 文件上传时间
	ContentType   string                 `protobuf:"bytes,6,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"` // 文件类型
	SignUrl       string                 `protobuf:"bytes,7,opt,name=sign_url,json=signUrl,proto3" json:"sign_url,omitempty"`             // 签名URL
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type OssListReq struct {
	...
	OrderBy       string                 `protobuf:"bytes,3,opt,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"`     // 排序
...
type CreateOssReq struct {
	...
	OssCode       string                 `protobuf:"bytes,3,opt,name=oss_code,json=ossCode,proto3" json:"oss_code,omitempty"`          // 资源编号
	Endpoint      string                 `protobuf:"bytes,4,opt,name=endpoint,proto3" json:"endpoint,omitempty"`                       // 资源地址
	AccessKey     string                 `protobuf:"bytes,5,opt,name=access_key,json=accessKey,proto3" json:"access_key,omitempty"`    // accessKey
	SecretKey     string                 `protobuf:"bytes,6,opt,name=secret_key,json=secretKey,proto3" json:"secret_key,omitempty"`    // secretKey
	BucketName    string                 `protobuf:"bytes,7,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 空间名
	AppId         string                 `protobuf:"bytes,8,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`                // 应用ID TencentCOS需要
...
type MakeBucketReq struct {
	...
	BucketName    string                 `protobuf:"bytes,3,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 存储桶名称
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type StatFileReq struct {
	...
	IsSign        bool                   `protobuf:"varint,5,opt,name=is_sign,json=isSign,proto3" json:"is_sign,omitempty"`            // 是否生成签名
...
type StatFileRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OssFile       *OssFile               `protobuf:"bytes,1,opt,name=oss_file,json=ossFile,proto3" json:"oss_file,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutFileReq struct {
	...
	IsThumb       bool                   `protobuf:"varint,7,opt,name=is_thumb,json=isThumb,proto3" json:"is_thumb,omitempty"`         // 是否缩略图
	PathPrefix    string                 `protobuf:"bytes,8,opt,name=path_prefix,json=pathPrefix,proto3" json:"path_prefix,omitempty"` // 默认值 default 文件路径前缀, 文件格式 pathPrefix/20060102/uuid.ext
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutStreamFileReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TenantId      string                 `protobuf:"bytes,1,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`       // 租户ID 默认值 000000
	Code          string                 `protobuf:"bytes,2,opt,name=code,proto3" json:"code,omitempty"`                               // 资源编号
	BucketName    string                 `protobuf:"bytes,3,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 存储桶名称
	Filename      string                 `protobuf:"bytes,4,opt,name=filename,proto3" json:"filename,omitempty"`                       // 上传文件名
	ContentType   string                 `protobuf:"bytes,5,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"`
	...
	IsThumb       bool                   `protobuf:"varint,8,opt,name=is_thumb,json=isThumb,proto3" json:"is_thumb,omitempty"`         // 是否缩略图
	PathPrefix    string                 `protobuf:"bytes,9,opt,name=path_prefix,json=pathPrefix,proto3" json:"path_prefix,omitempty"` // 默认值 upload 文件路径前缀, 文件格式 pathPrefix/20060102/uuid.ext
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutStreamFileRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	File          *File                  `protobuf:"bytes,1,opt,name=file,proto3" json:"file,omitempty"`
	IsEnd         bool                   `protobuf:"varint,2,opt,name=is_end,json=isEnd,proto3" json:"is_end,omitempty"` // 是否结束
	Size          int64                  `protobuf:"varint,3,opt,name=size,proto3" json:"size,omitempty"`                // 文件大小
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RelayTarget struct {
	...
	BucketName    string                 `protobuf:"bytes,3,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 存储桶名称
	Filename      string                 `protobuf:"bytes,4,opt,name=filename,proto3" json:"filename,omitempty"`                       // 上传文件名
	PathPrefix    string                 `protobuf:"bytes,5,opt,name=path_prefix,json=pathPrefix,proto3" json:"path_prefix,omitempty"` // 默认值 default 文件路径前缀
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RelayTarget) Reset() {
	*x = RelayTarget{}
...
func (x *RelayTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RelayTarget) ProtoMessage() {}

func (x *RelayTarget) ProtoReflect() protoreflect.Message {
	mi := &file_file_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RelayTarget.ProtoReflect.Descriptor instead.
func (*RelayTarget) Descriptor() ([]byte, []int) {
	return file_file_proto_rawDescGZIP(), []int{28}
}

func (x *RelayTarget) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *RelayTarget) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *RelayTarget) GetBucketName() string {
	if x != nil {
		return x.BucketName
	}
	return ""
...
func (x *RelayTarget) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *RelayTarget) GetPathPrefix() string {
	if x != nil {
		return x.PathPrefix
	}
	return ""
...
type RelayFileReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// source - 二选一
	SourceUrl     string         `protobuf:"bytes,1,opt,name=source_url,json=sourceUrl,proto3" json:"source_url,omitempty"`       // OSS HTTP 地址
	SourcePath    string         `protobuf:"bytes,2,opt,name=source_path,json=sourcePath,proto3" json:"source_path,omitempty"`    // 本地磁盘文件路径
	Targets       []*RelayTarget `protobuf:"bytes,3,rep,name=targets,proto3" json:"targets,omitempty"`                            // 目标 OSS 列表
	ContentType   string         `protobuf:"bytes,4,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty"` // 可选，不传则从源文件自动探测
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RelayFileReq) Reset() {
	*x = RelayFileReq{}
...
func (x *RelayFileReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RelayFileReq) ProtoMessage() {}

func (x *RelayFileReq) ProtoReflect() protoreflect.Message {
	mi := &file_file_proto_msgTypes[29]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RelayFileReq.ProtoReflect.Descriptor instead.
func (*RelayFileReq) Descriptor() ([]byte, []int) {
	return file_file_proto_rawDescGZIP(), []int{29}
}

func (x *RelayFileReq) GetSourceUrl() string {
	if x != nil {
		return x.SourceUrl
	}
	return ""
...
func (x *RelayFileReq) GetSourcePath() string {
	if x != nil {
		return x.SourcePath
	}
	return ""
...
func (x *RelayFileReq) GetTargets() []*RelayTarget {
	if x != nil {
		return x.Targets
	}
	return nil
...
func (x *RelayFileReq) GetContentType() string {
	if x != nil {
		return x.ContentType
	}
	return ""
...
type RelayFileRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Files         []*File                `protobuf:"bytes,1,rep,name=files,proto3" json:"files,omitempty"` // 上传成功的文件列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RelayFileRes) Reset() {
	*x = RelayFileRes{}
...
func (x *RelayFileRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RelayFileRes) ProtoMessage() {}

func (x *RelayFileRes) ProtoReflect() protoreflect.Message {
	mi := &file_file_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RelayFileRes.ProtoReflect.Descriptor instead.
func (*RelayFileRes) Descriptor() ([]byte, []int) {
	return file_file_proto_rawDescGZIP(), []int{30}
}

func (x *RelayFileRes) GetFiles() []*File {
	if x != nil {
		return x.Files
	}
	return nil
...
type CaptureVideoStreamReq struct {
	...
	Code          string                 `protobuf:"bytes,2,opt,name=code,proto3" json:"code,omitempty"`                               // 资源编号
	BucketName    string                 `protobuf:"bytes,3,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"` // 存储桶名称
	PathPrefix    string                 `protobuf:"bytes,5,opt,name=path_prefix,json=pathPrefix,proto3" json:"path_prefix,omitempty"` // 默认值 default 文件路径前缀, 文件格式 pathPrefix/20060102/uuid.ext
	StreamUrl     string                 `protobuf:"bytes,6,opt,name=stream_url,json=streamUrl,proto3" json:"stream_url,omitempty"`    // 视频流
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_file_proto_rawDesc = "" +
	...
	"\x03Res\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong\"\x85\x03\n" +
	"\x03Oss\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\ttenant_id\x18\x02 \x01(\tR\btenantId\x12\x1a\n" +
	"\bcategory\x18\x03 \x01(\x03R\bcategory\x12\x19\n" +
	"\boss_code\x18\x04 \x01(\tR\aossCode\x12\x1a\n" +
	"\bendpoint\x18\x05 \x01(\tR\bendpoint\x12\x1d\n" +
	"\n" +
	"access_key\x18\x06 \x01(\tR\taccessKey\x12\x1d\n" +
	"\n" +
	"secret_key\x18\a \x01(\tR\tsecretKey\x12\x1f\n" +
	...
	"\x06status\x18\f \x01(\x03R\x06status\x12\x1f\n" +
	...
	"\vformat_size\x18\x05 \x01(\tR\n" +
	"formatSize\x12#\n" +
	"\roriginal_name\x18\x06 \x01(\tR\foriginalName\x12\x1b\n" +
	"\tattach_id\x18\a \x01(\tR\battachId\x12\x10\n" +
	"\x03md5\x18\b \x01(\tR\x03md5\x12#\n" +
	"\x04meta\x18\t \x01(\v2\x0f.file.ImageMetaR\x04meta\x12\x1d\n" +
	"\n" +
	"thumb_link\x18\n" +
	" \x01(\tR\tthumbLink\x12\x1d\n" +
	"\n" +
	"thumb_name\x18\v \x01(\tR\tThumbName\"\xee\x02\n" +
	"\tImageMeta\x12\x1c\n" +
	...
	"\n" +
	"img_height\x18\x04 \x01(\x05R\timgHeight\x12\x1b\n" +
	"\timg_width\x18\x05 \x01(\x05R\bimgWidth\x12\x1a\n" +
	"\baltitude\x18\x06 \x01(\x01R\baltitude\x12!\n" +
	"\fcamera_model\x18\a \x01(\tR\vcameraModel\x12,\n" +
	"\x12body_serial_number\x18\b \x01(\tR\x10bodySerialNumber\x120\n" +
	"\x05extra\x18\t \x03(\v2\x1a.file.ImageMeta.ExtraEntryR\x05extra\x1a8\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	...
	"\vformat_size\x18\x04 \x01(\tR\n" +
	"formatSize\x12\x19\n" +
	"\bput_time\x18\x05 \x01(\tR\aputTime\x12!\n" +
	"\fcontent_type\x18\x06 \x01(\tR\vcontentType\x12\x19\n" +
	"\bsign_url\x18\a \x01(\tR\asignUrl\"\x1e\n" +
	"\fOssDetailReq\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"+\n" +
	"\fOssDetailRes\x12\x1b\n" +
	"\x03oss\x18\x01 \x01(\v2\t.file.OssR\x03oss\"\x91\x01\n" +
	"\n" +
	"OssListReq\x12\x12\n" +
	...
	"\fCreateOssReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x1a\n" +
	"\bcategory\x18\x02 \x01(\x03R\bcategory\x12\x19\n" +
	"\boss_code\x18\x03 \x01(\tR\aossCode\x12\x1a\n" +
	"\bendpoint\x18\x04 \x01(\tR\bendpoint\x12\x1d\n" +
	"\n" +
	"access_key\x18\x05 \x01(\tR\taccessKey\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x06 \x01(\tR\tsecretKey\x12\x1f\n" +
	"\vbucket_name\x18\a \x01(\tR\n" +
	"bucketName\x12\x15\n" +
	"\x06app_id\x18\b \x01(\tR\x05appId\x12\x16\n" +
	...
	"\rMakeBucketReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\"\x0f\n" +
	"\rMakeBucketRes\"c\n" +
	"\x0fRemoveBucketReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\"\x11\n" +
	"\x0fRemoveBucketRes\"\xae\x01\n" +
	"\vStatFileReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	"\bfilename\x18\x04 \x01(\tR\bfilename\x12\x17\n" +
	"\ais_sign\x18\x05 \x01(\bR\x06isSign\x12\x18\n" +
	"\aexpires\x18\x06 \x01(\x05R\aexpires\"7\n" +
	"\vStatFileRes\x12(\n" +
	"\boss_file\x18\x01 \x01(\v2\r.file.OssFileR\aossFile\"\x94\x01\n" +
	"\n" +
	"SignUrlReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	...
	"\n" +
	"SignUrlRes\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\"\xed\x01\n" +
	"\n" +
	"PutFileReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	...
	"\bis_thumb\x18\a \x01(\bR\aisThumb\x12\x1f\n" +
	"\vpath_prefix\x18\b \x01(\tR\n" +
	"pathPrefix\",\n" +
	"\n" +
	"PutFileRes\x12\x1e\n" +
	"\x04file\x18\x01 \x01(\v2\n" +
	".file.FileR\x04file\"\x8d\x02\n" +
	"\x10PutStreamFileReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	...
	"\bis_thumb\x18\b \x01(\bR\aisThumb\x12\x1f\n" +
	"\vpath_prefix\x18\t \x01(\tR\n" +
	"pathPrefix\"]\n" +
	"\x10PutStreamFileRes\x12\x1e\n" +
	"\x04file\x18\x01 \x01(\v2\n" +
	".file.FileR\x04file\x12\x15\n" +
	"\x06is_end\x18\x02 \x01(\bR\x05isEnd\x12\x12\n" +
	"\x04size\x18\x03 \x01(\x03R\x04size\"\x9c\x01\n" +
	"\vRelayTarget\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	...
	"pathPrefix\"\x9e\x01\n" +
	"\fRelayFileReq\x12\x1d\n" +
	"\n" +
	"source_url\x18\x01 \x01(\tR\tsourceUrl\x12\x1f\n" +
	"\vsource_path\x18\x02 \x01(\tR\n" +
	"sourcePath\x12+\n" +
	"\atargets\x18\x03 \x03(\v2\x11.file.RelayTargetR\atargets\x12!\n" +
	"\fcontent_type\x18\x04 \x01(\tR\vcontentType\"0\n" +
	"\fRelayFileRes\x12 \n" +
	"\x05files\x18\x01 \x03(\v2\n" +
	".file.FileR\x05files\"z\n" +
	"\n" +
	"GetFileReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	"\bfilename\x18\x04 \x01(\tR\bfilename\"_\n" +
	"\n" +
	"GetFileRes\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12!\n" +
	"\fcontent_type\x18\x02 \x01(\tR\vcontentType\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path\"}\n" +
	"\rRemoveFileReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	...
	"\rRemoveFileRes\"~\n" +
	"\x0eRemoveFilesReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1a\n" +
	"\bfilename\x18\x04 \x03(\tR\bfilename\"\xa9\x01\n" +
	"\x15CaptureVideoStreamReq\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\x12\x1f\n" +
	"\vbucket_name\x18\x03 \x01(\tR\n" +
	"bucketName\x12\x1f\n" +
	...
	"pathPrefix\x12\x1d\n" +
	"\n" +
	"stream_url\x18\x06 \x01(\tR\tstreamUrl\"7\n" +
	"\x15CaptureVideoStreamRes\x12\x1e\n" +
	"\x04file\x18\x01 \x01(\v2\n" +
	".file.FileR\x04file2\xea\x06\n" +
	"\aFileRpc\x12\x1c\n" +
	...
	"\aPutFile\x12\x10.file.PutFileReq\x1a\x10.file.PutFileRes\x12A\n" +
	"\rPutStreamFile\x12\x16.file.PutStreamFileReq\x1a\x16.file.PutStreamFileRes(\x01\x123\n" +
	"\tRelayFile\x12\x12.file.RelayFileReq\x1a\x12.file.RelayFileRes\x126\n" +
	"\n" +
...
var file_file_proto_goTypes = []any{
	...
	(*PutStreamFileReq)(nil),      // 26: file.PutStreamFileReq
	(*PutStreamFileRes)(nil),      // 27: file.PutStreamFileRes
	(*RelayTarget)(nil),           // 28: file.RelayTarget
	(*RelayFileReq)(nil),          // 29: file.RelayFileReq
	(*RelayFileRes)(nil),          // 30: file.RelayFileRes
	(*GetFileReq)(nil),            // 31: file.GetFileReq
	(*GetFileRes)(nil),            // 32: file.GetFileRes
	(*RemoveFileReq)(nil),         // 33: file.RemoveFileReq
	(*RemoveFileRes)(nil),         // 34: file.RemoveFileRes
...
var file_file_proto_depIdxs = []int32{
	...
	5,  // 4: file.StatFileRes.oss_file:type_name -> file.OssFile
