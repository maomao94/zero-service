...
func (UnimplementedFileRpcServer) OssDetail(context.Context, *OssDetailReq) (*OssDetailRes, error) {
	return nil, status.Error(codes.Unimplemented, "method OssDetail not implemented")
}
func (UnimplementedFileRpcServer) OssList(context.Context, *OssListReq) (*OssListRes, error) {
	return nil, status.Error(codes.Unimplemented, "method OssList not implemented")
}
func (UnimplementedFileRpcServer) CreateOss(context.Context, *CreateOssReq) (*CreateOssRes, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOss not implemented")
}
func (UnimplementedFileRpcServer) UpdateOss(context.Context, *UpdateOssReq) (*UpdateOssRes, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateOss not implemented")
}
func (UnimplementedFileRpcServer) DeleteOss(context.Context, *DeleteOssReq) (*DeleteOssRes, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteOss not implemented")
}
...
func (UnimplementedFileRpcServer) SignUrl(context.Context, *SignUrlReq) (*SignUrlRes, error) {
	return nil, status.Error(codes.Unimplemented, "method SignUrl not implemented")
}
...
func (UnimplementedFileRpcServer) PutStreamFile(grpc.ClientStreamingServer[PutStreamFileReq, PutStreamFileRes]) error {
	return status.Error(codes.Unimplemented, "method PutStreamFile not implemented")
}
func (UnimplementedFileRpcServer) RelayFile(context.Context, *RelayFileReq) (*RelayFileRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RelayFile not implemented")
}
...
func (UnimplementedFileRpcServer) RemoveFiles(context.Context, *RemoveFilesReq) (*RemoveFileRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveFiles not implemented")
}
func (UnimplementedFileRpcServer) CaptureVideoStream(context.Context, *CaptureVideoStreamReq) (*CaptureVideoStreamRes, error) {
	return nil, status.Error(codes.Unimplemented, "method CaptureVideoStream not implemented")
}
...
func RegisterFileRpcServer(s grpc.ServiceRegistrar, srv FileRpcServer) {
	// If the following call panics, it indicates UnimplementedFileRpcServer was
