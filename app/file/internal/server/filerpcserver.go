...
func (s *FileRpcServer) RelayFile(ctx context.Context, in *file.RelayFileReq) (*file.RelayFileRes, error) {
	l := logic.NewRelayFileLogic(ctx, s.svcCtx)
	return l.RelayFile(in)
}
