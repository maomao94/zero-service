...
import (
	...
	"zero-service/app/djigateway/internal/server"
...
var configFile = flag.String("f", "etc/djigateway.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		djigateway.RegisterDjiGatewayServer(grpcServer, server.NewDjiGatewayServer(ctx))
