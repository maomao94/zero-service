...
| [iec104-control-commands.md](./iec104-control-commands.md) | 新增/修改 ieccaller 控制方向 gRPC 接口、core.go Send*Cmd、MQTT 广播 consumer 或集群 ACK reply | IEC 104 typed 命令全链路、typeId 映射、qualifier 约定、六层文件修改清单、MQTT 广播 tId/ackTopic/replyPool 契约 |
