...
type FenceStore interface {
	...
	// 参数顺序：(lon, lat, km)，与全项目坐标约定 {lon, lat} 一致。
	...
	UpdateFence(ctx context.Context, fenceId, name string, polygon orb.Polygon, h3Resolution, geohashPrecision int, h3Cells, geohashCells []string) error
...
func (s *NoopFenceStore) CreateFence(ctx context.Context, fenceId, name string, polygon orb.Polygon, h3Resolution, geohashPrecision int, h3Cells, geohashCells []string) error {
	return ErrFenceStoreNotImplemented
}

func (s *NoopFenceStore) LoadFencePolygon(ctx context.Context, fenceId string) (orb.Polygon, error) {
	return nil, ErrFenceStoreNotImplemented
}

func (s *NoopFenceStore) FindNearbyFenceIds(ctx context.Context, lon, lat, km float64) ([]string, error) {
	return nil, ErrFenceStoreNotImplemented
}
...
func (s *NoopFenceStore) UpdateFence(ctx context.Context, fenceId, name string, polygon orb.Polygon, h3Resolution, geohashPrecision int, h3Cells, geohashCells []string) error {
	return ErrFenceStoreNotImplemented
}
