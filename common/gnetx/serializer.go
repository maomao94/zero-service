...
func (RawSerializer) Decode(raw []byte, _ *Session) (any, error) {
...
func (RawSerializer) Encode(msg any, _ *Session) ([]byte, error) {
	if b, ok := msg.([]byte); ok {
		out := make([]byte, len(b))
		copy(out, b)
		return out, nil
...
func (JSONSerializer) Decode(raw []byte, _ *Session) (any, error) {
...
func (JSONSerializer) Encode(msg any, _ *Session) ([]byte, error) {
