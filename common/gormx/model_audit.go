...
// 返回值：
//   - []any: GORM 字段定义切片
func (m *BaseModel) AuditFields() []any {
	return []any{
		&struct {
...
func (m *IntBaseModel) AuditFields() []any {
	return []any{
		&struct {
			CreateUser uint   `gorm:"index"`
			CreateName string `gorm:"size:64"`
...
// GetVersion 获取版本号
func (m *IntBaseModel) GetVersion() int64 {
	return m.Version
}

// SetVersion 设置版本号
func (m *IntBaseModel) SetVersion(v int64) {
	m.Version = v
}

// IncrementVersion 版本号 +1
func (m *IntBaseModel) IncrementVersion() {
	m.Version++
}

// IsDeleted 检查是否已软删除
func (m *IntBaseModel) IsDeleted() bool {
	return m.DeletedAt.Valid && !m.DeletedAt.Time.IsZero()
}
...
// AuditFields 获取审计字段定义
func (m *StringBaseModel) AuditFields() []any {
	return []any{
		&struct {
			CreateUser uint   `gorm:"index"`
			CreateName string `gorm:"size:64"`
...
// GetVersion 获取版本号
func (m *StringBaseModel) GetVersion() int64 {
	return m.Version
}

// SetVersion 设置版本号
func (m *StringBaseModel) SetVersion(v int64) {
	m.Version = v
}

// IncrementVersion 版本号 +1
func (m *StringBaseModel) IncrementVersion() {
	m.Version++
}

// IsDeleted 检查是否已软删除
func (m *StringBaseModel) IsDeleted() bool {
	return m.DeletedAt.Valid && !m.DeletedAt.Time.IsZero()
}

// ============ TimeBaseModel 方法（无软删除） ============

// AuditFields 获取审计字段定义
func (m *TimeBaseModel) AuditFields() []any {
	return []any{
		&struct {
			CreateUser uint   `gorm:"index"`
			CreateName string `gorm:"size:64"`
...
// GetVersion 获取版本号
func (m *TimeBaseModel) GetVersion() int64 {
	return m.Version
}

// SetVersion 设置版本号
func (m *TimeBaseModel) SetVersion(v int64) {
	m.Version = v
}

// IncrementVersion 版本号 +1
func (m *TimeBaseModel) IncrementVersion() {
	m.Version++
}
